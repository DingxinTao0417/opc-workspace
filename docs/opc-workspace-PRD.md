...
> 文档日期：2026-09-10
> 实现基线：app v0.1.1 / API v1 / SQLite schema v70
...
| T-04 SQLite 初始化与迁移             | 已完成                           | schema v70（含 AI/知识库、PDF 页码、配置身份与可靠确认迁移）、PRAGMA、嵌入迁移、demo 清理、Project/Task/Actor/Client/Focus/Inbox/Reminder、设置/保存视图、三类业务附件、Workspace Avatar、存储阈值、Submission origin、父任务 rollup guards、Project→Client Activity 唯一来源、Reminder 系列/occurrence、Automation Rule/Run、Agent Adapter 诊断、Client Followup 计划/终态事实与其他来源 guards                                                                                                                                                                  |
