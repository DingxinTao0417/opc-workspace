...
> 文档版本：2.89
> 日期：2026-08-29
> 依据：[PRD v9.82](opc-workspace-PRD.md)
> 当前实现基线：app v0.1.0 / API v1 / SQLite schema v43
...
- SQLite 当前为 schema v43：schema v11–v42 交付 Focus、Inbox/Reminder/编排、设置/保存视图、Client、附件、来源 guards、Automation、Agent Adapter、Client Followup、Roadmap/Content 与关闭到托盘；schema v43 加法新增容量历史表。v30–v43 都不创建业务 demo 数据；容量样本只由真实探测产生，Sidecar 只幂等登记默认禁用的 Automation 预设。
