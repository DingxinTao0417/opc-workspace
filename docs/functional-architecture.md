...
> 文档版本：2.68
> 日期：2026-08-29
> 依据：[PRD v9.54](opc-workspace-PRD.md)
...
| [内容日历](modules/content-calendar.md)    | Project、Task、日期                                                                                                     | 内容计划、准备 Task 关系、本地发布确认；CC2 API、CC3 月度工作区与 CC4 编辑/改期/发布确认已交付                                                                                           | 准备 Task（读取已交付、编辑待开发）；审核/发布时间 Inbox 事件仍待                                                                                                   |
