...
> 文档版本：2.66
> 日期：2026-08-29
> 依据：[PRD v9.49](opc-workspace-PRD.md)
> 当前实现基线：app v0.1.0 / API v1 / SQLite schema v36

> 2.66 说明：路线图 R2 已在 Sidecar 提供里程碑 CRUD、季度/状态/项目筛选、项目关联、派生 Task 完成度、乐观并发、归档恢复和同季度单事务重排；页面、拖拽和 Inbox/Reminder 投影仍未实现。2.65 的客户回访客户端草稿收口边界不变。
...
| [路线图](modules/roadmap.md)               | Project/Task 派生进度                                                                                                   | 已交付季度里程碑数据/API、项目关联和只读进度；页面与本地事件待后续                                                                                                                         | 当前无 Inbox 事件；后续临期/达成投影                                                                                                                            |
