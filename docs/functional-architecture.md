...
> 文档版本：2.71
> 日期：2026-08-29
> 依据：[PRD v9.60](opc-workspace-PRD.md)
> 当前实现基线：app v0.1.0 / API v1 / SQLite schema v38

> 2.71 说明：路线图 R3 已接入版本化基础事实编辑与保护性永久删除；前端只允许从归档视图进入二次确认，Sidecar 继续强制确认参数、乐观版本和归档状态门禁。
...
| [路线图](modules/roadmap.md)               | Project/Task 派生进度                                                                                                   | 已交付季度里程碑数据/API、项目关联、只读进度以及新建/编辑/归档恢复/保护性删除；详情、分页、拖拽与本地事件待后续                                                                           | 当前无 Inbox 事件；后续临期/达成投影                                                                                                                             |
