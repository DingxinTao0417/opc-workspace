...
> 文档版本：2.68
> 日期：2026-08-29
> 依据：[PRD v9.52](opc-workspace-PRD.md)
...
| [内容日历](modules/content-calendar.md)    | Project、Task、日期                                                                                                     | 内容计划、准备 Task 关系与本地发布确认；CC2 API 已通过 Sidecar/SQLite 交付                                                                                                                | 准备 Task（已交付）；审核/发布时间 Inbox 事件仍待                                                                                                                   |
