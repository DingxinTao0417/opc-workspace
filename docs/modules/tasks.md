...
> 实现基线：app v0.1.0 / API v1 / SQLite schema v20（2026-08-28）；Task D2 结构仍由 schema v9 引入，schema v11 通过 Focus 精确秒数账本向 `actual_minutes` 追加完整分钟；schema v17 新增保存视图表，schema v18–v20 新增客户活动/附件/person 关联，均不改写 Task 表。
>
...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v5.4](../opc-workspace-PRD.md) · [Actor 与分派](actors.md) · [数据管理](data-management.md)
