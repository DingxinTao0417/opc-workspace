...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v5.2](../opc-workspace-PRD.md) · [收件箱](inbox.md) · [桌面平台](desktop-platform.md)
...
迁移为纯加法，不创建 demo Reminder，也不改写 schema v13 的 Task、Inbox、Client、Project、Focus 或 Artifact 事实。其后的 schema v15 仅增加 Inbox 编排校验，schema v16 增加 app_settings，schema v17 增加任务保存视图，schema v18 增加客户活动；后续迁移必须从 `019_*` 继续。
