...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v5.4](../opc-workspace-PRD.md) · [收件箱](inbox.md) · [桌面平台](desktop-platform.md)
...
迁移为纯加法，不创建 demo Reminder，也不改写 schema v13 的 Task、Inbox、Client、Project、Focus 或 Artifact 事实。其后的 schema v15–v20 增加 Inbox 编排、app_settings、任务保存视图、客户活动/附件/person 关联；后续迁移必须从 `021_*` 继续。
