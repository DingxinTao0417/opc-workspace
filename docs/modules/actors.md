...
> 实现基线：app v0.1.0 / API v1 / SQLite schema v15（2026-08-28）；Actor/D2 结构仍分别由 schema v7/v9 引入，schema v10–v14 不改写其契约；v12 新增独立 Inbox Item，v13 新增 Inbox–Task 关系和 Task 删除互锁，v14 新增引用 owner/system 的一次性 Reminder。
>
...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v3.3](../opc-workspace-PRD.md) · [任务模块](tasks.md) · [本地 Agent](local-agents.md)
...
1. 若 person 仍有活动 Assignment，API 返回冲突，不递增 Actor version、不写事件。
2. 先通过 Task 详情改派或结束全部活动 Assignment。
