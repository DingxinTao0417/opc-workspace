...
> 实现基线：app v0.1.0 / API v1 / SQLite schema v18（2026-08-28）；Actor/D2 结构仍分别由 schema v7/v9 引入，schema v10–v18 不改写其契约；v16 的 app_settings 和 v18 的客户活动只引用 active Actor 作为修改者/记录人。
>
...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v5.2](../opc-workspace-PRD.md) · [任务模块](tasks.md) · [本地 Agent](local-agents.md)
