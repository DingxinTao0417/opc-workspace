...
- 所有新结构用 `003_...` 起的递增迁移，不能修改已发布的 `001_initial_schema.sql`。
...
- Task Assignment、Artifact、review 和 Inbox/Task events API 由共享工作流基础提供。
...
1. **前置：Actor/Task 工作流基础**：完成 actors、Assignment、扩展状态、Artifact、Workflow Event 和状态命令。
