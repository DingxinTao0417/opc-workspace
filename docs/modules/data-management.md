...
> 当前基线：app v0.1.0 / API v1 / SQLite schema v40（2026-08-29）
>
...
- [x] schema v40 在回滚包保护下重建 Reminder 约束并保留既有事实，增加 monthly 与当地日锚点；失败时停留在 v39。
