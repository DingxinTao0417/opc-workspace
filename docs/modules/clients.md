...
>
> 当前基线：app v0.1.0 / API v1 / SQLite schema v14。客户事实仍由 schema v10 引入；schema v12 新增独立 Inbox Item，schema v13 新增 Inbox–Task 关系和 Task 删除互锁，schema v14 新增独立一次性 Reminder，均不改 Client 结构。v0.1 的基础资料 CRUD、基础详情和 Project 客户关联已交付，模块仍为**部分完成**；活动、附件、Actor 显式关联、回访和财务聚合尚未交付。
