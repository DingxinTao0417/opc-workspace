...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.66](../opc-workspace-PRD.md)
...
- [路线图](roadmap.md)（R2 数据/API、R3 基础界面与 R5 本地 Inbox 事件已完成，R4 已交付同季度安全排序和年度跨季度拖拽/键盘移动；精确日期拖拽待开发）
