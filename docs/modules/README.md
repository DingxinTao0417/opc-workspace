...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.1](../opc-workspace-PRD.md)
...
- [收件箱工作编排](inbox.md)（T-11A1/A2/A3/B/C/F 和 T-11E follow-up Artifact/Task 阻塞/Task 临期/Project 完成、备份操作、数据库启动/迁移、Sidecar 启动、运行期数据库操作失败及固定低空间监测已交付；阈值配置和 Agent 待开发）
...
- [数据、受控文件、备份与恢复](data-management.md)（受控文件 store、一致性备份恢复、启动后恢复结果诊断、故障 Inbox、桌面安全重启，以及业务 JSON/含文件 ZIP 的空工作区安全导入导出已交付；数据库打开前恢复页、非空目标/跨 schema 冲突合并仍待开发）
