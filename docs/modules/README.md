...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v4.7](../opc-workspace-PRD.md)
...
- [数据、受控文件、备份与恢复](data-management.md)（Artifact store、手动一致性备份创建/列表/校验和隔离恢复演练已交付；实际替换/删除/导出仍待开发）
