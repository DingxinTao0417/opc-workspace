...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v3.9](../opc-workspace-PRD.md)

## v0.1 核心闭环

- [今日工作台](today.md)（T-06A–F 日期分组、导航、按钮/同组拖拽排序、行内任意日期/未排期安排和安全执行快捷操作已交付；跨分组拖拽与行内编辑/删除待开发）
