...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v2.6](../opc-workspace-PRD.md)
...
- [收件箱工作编排](inbox.md)（T-11A1/A2/B 的手工受理分诊、已有 Task 活动/历史关系与实时进度已交付；拆分/分派/自动解决、来源投影和 Agent 待开发）
