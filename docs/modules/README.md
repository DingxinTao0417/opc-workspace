...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v5.9](../opc-workspace-PRD.md)
...
- [项目管理](projects.md)（基础纵切、Client 选择/筛选、可编辑人工笔记和追加式项目活动时间线已交付；项目级产出/附件与 Inbox 来源投影仍待开发）
