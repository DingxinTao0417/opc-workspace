...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.65](../opc-workspace-PRD.md)
...
- [路线图](roadmap.md)（R2 数据/API 与 R3 基础界面已完成，R4 已交付同季度安全排序和年度跨季度拖拽/键盘移动；精确日期拖拽与本地事件待开发）
