...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v4.0](../opc-workspace-PRD.md)

## v0.1 核心闭环

- [今日工作台](today.md)（T-06A–G 日期分组、导航、按钮排序、同日/跨日期拖拽、空精确日期/未排期落点、行内任意日期安排和安全执行快捷操作已交付；行内编辑/删除待开发）
