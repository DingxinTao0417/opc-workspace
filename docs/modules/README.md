...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v5.2](../opc-workspace-PRD.md)
...
- [数据、受控文件、备份与恢复](data-management.md)（Artifact store、手动一致性备份完整闭环、桌面安全重启和基础业务 JSON 导出已交付；迁移前备份、恢复诊断、导入/含文件外部包仍待开发）
