...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.63](../opc-workspace-PRD.md)
...
- [路线图](roadmap.md)（R2 数据/API 与 R3 基础界面已完成，R4 已交付完整同季度集合的拖拽/键盘安全排序；目标日期/跨季度拖拽与本地事件待开发）
