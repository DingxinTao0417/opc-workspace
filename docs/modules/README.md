...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v5.3](../opc-workspace-PRD.md)
...
- [客户管理](clients.md)（基础资料 CRUD、Project 关联、人工活动时间线和受控附件已交付；外部来源/Actor 关联/回访/财务仍待开发）
