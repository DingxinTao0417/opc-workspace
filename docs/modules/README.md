...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.11](../opc-workspace-PRD.md)
...
- [项目管理](projects.md)（基础纵切、任务树/平铺及项目内组合筛选/服务端分页、Client、笔记、附件、Task Artifact 聚合、活动时间线、显式 follow-up 产出和 Project 完成节点→Inbox 已交付；高级分析待开发）
