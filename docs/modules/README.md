...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.62](../opc-workspace-PRD.md)
...
- [路线图](roadmap.md)（R2 数据/API 与 R3 基础界面已完成：季度/Project 筛选、稳定分页、新建/编辑/详情、Project 跳转、归档恢复与保护性删除；拖拽与本地事件待开发）
