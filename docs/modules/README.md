...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v2.5](../opc-workspace-PRD.md)

## v0.1 核心闭环

- [今日工作台](today.md)
- [任务管理](tasks.md)（事实层、D1/D2 与 Inbox 已有 Task 关系删除互锁已交付；批量编排/来源消费与 Agent 仍待开发）
...
- [收件箱工作编排](inbox.md)（T-11A1/A2/B 的手工受理分诊、已有 Task 活动/历史关系与实时进度已交付；拆分/分派/自动解决、Reminder、来源投影和 Agent 待开发）
