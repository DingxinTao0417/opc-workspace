...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.74](../opc-workspace-PRD.md)
...
- [路线图](roadmap.md)（R2 数据/API、R3 基础界面与 R5 本地 Inbox 事件已完成，R4 已交付同季度安全排序、年度跨季度/跨年度移动与季度内精确日期拖拽/键盘输入；目标日期排序和 Today 最近节点联动已接通）
