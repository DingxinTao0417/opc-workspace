...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v8.7](../opc-workspace-PRD.md)
...
- [数据、受控文件、备份与恢复](data-management.md)（受控文件 store、一致性备份恢复、故障 Inbox、桌面安全重启，以及业务 JSON/含文件 ZIP 的空工作区安全导入导出已交付；恢复诊断、非空目标/跨 schema 冲突合并仍待开发）
