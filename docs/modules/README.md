...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.82](../opc-workspace-PRD.md)
...
- [数据、受控文件、备份与恢复](data-management.md)（一致性备份恢复、启动恢复、业务 JSON/ZIP、只读导入冲突预检，以及 schema v43 无路径 30 天容量历史/设置页 7 天趋势已交付；启动前备份选择、实际冲突合并与版本升级仍待开发）
