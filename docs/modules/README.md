...
导航：[文档中心](../README.md) · [整体功能架构](../functional-architecture.md) · [PRD v9.60](../opc-workspace-PRD.md)
...
- [路线图](roadmap.md)（R2 数据/API 与 R3 基础事实交互已交付：季度浏览、新建/编辑、Project 跳转、归档恢复与保护性删除；详情、分页、拖拽与本地事件待开发）
