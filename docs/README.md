...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v37。v9.56 已完成内容日历 CC4-B 六周月格、跨日/可见跨月拖拽和 IANA/DST 安全改期；v9.55 已完成准备任务关联。Inbox/调度仍待。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.56）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
