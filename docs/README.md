...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v38。v9.60 已完成路线图 R3 的基础事实编辑与保护性永久删除；不调用外部发布平台。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.60）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
...
| 路线图           | R2 数据/API 与 R3 新建/编辑/归档恢复/保护性删除完成；详情、分页、拖拽与本地事件待开发 | v0.3     | [roadmap.md](modules/roadmap.md)                   |
