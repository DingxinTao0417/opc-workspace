...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v39。v9.66 已交付路线图本地到期/达成 Inbox 事件、补偿扫描和来源生命周期；不调用外部发布平台。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.66）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
...
| 路线图           | R2/R3/R5 完成，R4 同季度排序和年度跨季度移动已交付；精确日期拖拽待开发           | v0.3     | [roadmap.md](modules/roadmap.md)                   |
