...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v15。项目/任务/Actor、D2 Submission/Artifact、Client 基础事实、Focus Core A+B+C、T-11A1/A2/B 手工 Inbox 受理分诊与已有 Task 关系、T-11A3 一次性本地 Reminder，以及 T-11C 批量拆分/分派/自动结清已接通；Focus D、客户活动/附件、非 Reminder 业务来源投影、重复/原生通知、本地 Agent、备份恢复、回访/财务及项目附件/事件仍是规划。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v3.2）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
