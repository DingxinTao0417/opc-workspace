...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v38。v9.59 已完成内容日历 CC6-A 的六周范围自动分页聚合、加载进度和后续页重试；不调用外部发布平台。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.59）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
