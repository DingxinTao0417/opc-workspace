...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v37。v9.55 已完成内容日历 CC5-A 的准备任务关联、required/optional 标记与解除关联；CC4 已完成详情编辑、改期和人工发布确认。月格拖拽与 Inbox/调度仍待。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.55）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
...
| 内容日历         | CC5-A 准备任务关联已交付；月格拖拽和 Inbox/调度待开发                            | v0.3     | [content-calendar.md](modules/content-calendar.md) |
