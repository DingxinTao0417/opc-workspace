...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v38。v9.63 已完成路线图 R4 同季度安全排序首个纵切，支持完整集合的拖拽/键盘预览和全量版本原子保存；不调用外部发布平台。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.63）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
