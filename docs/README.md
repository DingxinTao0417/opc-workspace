...
| 路线图           | R2 数据契约已完成（季度里程碑、Project 关联、导入导出）；API/UI 仍未实现          | v0.3     | [roadmap.md](modules/roadmap.md)                   |
