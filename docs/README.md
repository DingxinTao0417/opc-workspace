...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v37。v9.54 已完成内容日历 CC4 的详情编辑、表单改期与人工发布确认；v9.53 已完成首个 React 月度工作区，v9.52 已完成本地 API，v9.51 已完成数据契约。月格拖拽、准备任务编辑与 Inbox/调度仍待。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.54）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
...
| 内容日历         | CC4 详情编辑/改期/发布确认已交付；月格拖拽待开发                                 | v0.3     | [content-calendar.md](modules/content-calendar.md) |
