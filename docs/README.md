...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v39。v9.67 已交付路线图季度内精确目标日期拖拽和键盘日期输入；不调用外部发布平台。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.67）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
