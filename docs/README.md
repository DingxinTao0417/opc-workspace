...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v41。v9.79 完成设置运行诊断的 1280/820/620/480 px 浏览器验收，并修复窄屏活动模块位于横向菜单视口外的问题；当前主机托盘原生链接、专注状态/动作和三平台交互仍待验收。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.79）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
