...
> 当前代码基线为 app v0.1.0 / API v1 / SQLite schema v41。v9.72 已交付周一至周五工作日 Reminder，继续复用 IANA/DST、即时预览与失败回滚；不调用外部服务。其余历史版本说明保持不变。

## 阅读顺序与事实优先级

1. [产品需求文档（PRD v9.72）](opc-workspace-PRD.md)：产品范围、版本边界、数据/API 目标契约和当前状态。
