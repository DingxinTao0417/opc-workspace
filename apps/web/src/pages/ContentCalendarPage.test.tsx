...
const hooks = vi.hoisted(() => ({ items: vi.fn(), projects: vi.fn(), update: vi.fn(), schedule: vi.fn(), publish: vi.fn() }));
vi.mock("../api/hooks", () => ({
...
describe("ContentCalendarPage", () => {
  afterEach(cleanup);
  beforeEach(() => {
    hooks.update.mockReset(); hooks.schedule.mockReset(); hooks.publish.mockReset();
