...
func TestAIEvaluationDatasetVersionMigrationPreservesV1AndAllowsV2(t *testing.T) {
	...
	if gated.SchemaVersion != 63 || gate == nil || gate.CurrentVersion != 63 || gate.TargetVersion != 67 ||
		len(gate.PendingVersions) != 4 || gate.PendingVersions[0] != 64 || gate.PendingVersions[1] != 65 || gate.PendingVersions[2] != 66 || gate.PendingVersions[3] != 67 {
		_ = gated.Close()
