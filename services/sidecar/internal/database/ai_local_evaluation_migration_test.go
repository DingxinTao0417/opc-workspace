...
func TestAIEvaluationDatasetVersionMigrationPreservesV1AndAllowsV2(t *testing.T) {
	...
	if gated.SchemaVersion != 63 || gate == nil || gate.CurrentVersion != 63 || gate.TargetVersion != 79 ||
		len(gate.PendingVersions) != 16 || gate.PendingVersions[0] != 64 || gate.PendingVersions[1] != 65 || gate.PendingVersions[2] != 66 || gate.PendingVersions[3] != 67 || gate.PendingVersions[4] != 68 || gate.PendingVersions[5] != 69 || gate.PendingVersions[6] != 70 || gate.PendingVersions[7] != 71 || gate.PendingVersions[8] != 72 || gate.PendingVersions[9] != 73 || gate.PendingVersions[10] != 74 || gate.PendingVersions[11] != 75 || gate.PendingVersions[12] != 76 || gate.PendingVersions[13] != 77 || gate.PendingVersions[14] != 78 || gate.PendingVersions[15] != 79 {
		_ = gated.Close()
