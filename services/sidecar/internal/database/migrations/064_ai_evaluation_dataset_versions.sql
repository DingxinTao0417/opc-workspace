...
-- Dataset v1 remains a historical measurement while newer code-owned datasets
-- get their own positive version. Rebuild both tables together so the result
-- foreign key continues to reference the rebuilt parent exactly.
CREATE TABLE ai_evaluation_runs_v64 (
    id TEXT PRIMARY KEY,
...
CREATE TABLE ai_evaluation_results_v64 (
    id TEXT PRIMARY KEY,
    run_id TEXT NOT NULL REFERENCES ai_evaluation_runs_v64(id) ON DELETE CASCADE,
...
INSERT INTO ai_evaluation_runs_v64 (
...
INSERT INTO ai_evaluation_results_v64 (
...
ALTER TABLE ai_evaluation_runs_v64 RENAME TO ai_evaluation_runs;
ALTER TABLE ai_evaluation_results_v64 RENAME TO ai_evaluation_results;
