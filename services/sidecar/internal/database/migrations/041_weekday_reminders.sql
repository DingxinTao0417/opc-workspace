...
CREATE TABLE reminders_v41 (
    ...
    recurrence_type TEXT NOT NULL DEFAULT 'none'
        CHECK (recurrence_type IN ('none', 'daily', 'weekly', 'weekdays', 'monthly')),
...
ALTER TABLE reminders_v41 RENAME TO reminders;
...
WHEN NEW.series_id IS NULL
  ...
  OR (
      NEW.recurrence_type IN ('daily', 'weekly', 'weekdays')
      AND (
