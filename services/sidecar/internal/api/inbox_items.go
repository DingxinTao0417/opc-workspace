...
func (a *API) listInboxItems(c *gin.Context) {
	...
	if sourceEntityType != "" && sourceEntityType != clientFollowupInboxSourceType && sourceEntityType != contentItemInboxSourceType && sourceEntityType != roadmapMilestoneInboxSourceType && sourceEntityType != invoiceDueInboxSourceType {
