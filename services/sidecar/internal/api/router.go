...
func NewRouter(db *gorm.DB, options Options) (*Router, error) {
	...
	v1.Use(service.maintenanceReadMiddleware())
	{
		...
		v1.GET("/ai/memory-proposals/:id", service.getAIMemoryProposal)
		...
		v1.GET("/ai/active-generations", service.listActiveAIGenerations)
		...
		v1.GET("/financial-entries", service.listFinancialEntries)
		v1.POST("/financial-entries", service.createFinancialEntry)
		v1.GET("/financial-entries/export.csv", service.exportFinancialEntriesCSV)
		v1.GET("/financial-entries/:id", service.getFinancialEntry)
		v1.PATCH("/financial-entries/:id", service.updateFinancialEntry)
		v1.DELETE("/financial-entries/:id", service.voidFinancialEntry)
		v1.GET("/invoices", service.listInvoices)
		v1.POST("/invoices", service.createInvoice)
		v1.GET("/invoices/:id", service.getInvoice)
